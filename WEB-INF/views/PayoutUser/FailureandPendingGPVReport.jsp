...
input[type=search]:not(.browser-default):focus:not([readonly]), input[type=email]:not(.browser-default):focus:not([readonly]) {
	box-shadow: none !important;
}
				...
				<div class="card blue-bg text-white">
					<div class="card-content">
						<div class="d-flex align-items-center">
							<h3 class="text-white">
								<strong>Failure/Pending Transactions</strong>
							</h3>
						</div>
...
<div class="row">
    <div class="col s12">
        <div class="card blue-bg text-white">
            <div class="card-content">
                <div class="row" style="display: flex; align-items: stretch; justify-content: flex-start;">
                    
                    <!-- Business Name -->
                    <div class="col s12 m3 l3 input-field businessname">
                        <label for="merchantName" id="label_businessname">Business Name</label>
                        <select name="merchantName" id="merchantName" path="merchantName" class="browser-default select-filter">
                            <optgroup label="Business Names" style="width: 100%">
                                <option selected value=""><c:out value="Select" /></option>
                    ...
                    <div class="input-field col s12 m3 l3">
                        ...
                        <input type="text" id="from" name="fromDate" class="validate datepicker" 	style="border-bottom: 1.5px solid #ffc800 !important; color: gray;width: 100%;"
                    ...
                    <div class="input-field col s12 m3 l3">
                        ...
                        <input type="text" id="to" name="toDate" class="datepicker" style="border-bottom: 1.5px solid #ffc800 !important;     color: gray;"
                    ...
                    <div class="choose input-field col s12 m3 l3">
                        <select id="export1" name="export" style="border-bottom: 1.5px solid #ffc800 !important;">
                            <option value="" selected>Select</option>
                            <option value="All">All</option>
                            <option value="Pending">Pending</option>
                            <option value="Failure">Failure</option>
                        </select>
                        <label for="export1">Status</label>
                    </div>

                    <!-- Export Button -->
                    <div class="input-field col s12 m3 l3">
                        <div class="button-class">
                            <button class="export-btn waves-effect waves-light btn btn-round indigo three-btn-one"
		...
		<div id="email-modal-id" class="email-modal-class"
			...
			<div class="email-content-class">
				<div
					style="text-align: center; border-bottom: 1.5px solid #ffc800; padding: 2%;">
					<p style="font-size: 16px; font-weight: 500; color: #005baa;">Details</p>
				</div>
				<div
					...
					<div
						...
						<img
							src="${pageContext.request.contextPath}/resourcesNew1/assets/email.svg"
							width="45px">
						<div style="width: 100%; text-align: center;">
    <p style="color: #586570;">
        Enter your email address.<br>
        We'll send the file directly to your inbox.
    </p>
</div>
					...
					<div style="padding: 0 10%; width: 100%;">
						<input type="email" id="email-input" name="email"
							...
							style="width: 100%; border-bottom: 1.5px solid #ffc800 !important; text-align: center;">
				...
				<div
					...
					<button type="button" id="email-submit-btn-submit"
						class="email-submit-class" onclick="submitEmail()">Send</button>
				</div>
			</div>
		</div>
...
.email-submit-class:hover,
.email-submit-class:focus {
    box-shadow: 0 4px 8px rgba(0, 90, 170, 0.3); /* Soft shadow effect */
...
#export1 {
    ...
    border-bottom: 1.5px solid #ffc800 !important; 
    background-color: transparent !important;
    padding: 5px !important;
    box-shadow: none !important;  /* Remove Materialize box-shadow */
}
...
/* Reset the color of calendar and dropdown icons */
.input-field i.material-icons {
    color: #9e9e9e !important; /* Default Materialize icon color */
}

/* Ensure select dropdown arrow is the default color */
.select-wrapper input.select-dropdown {
    color: rgb(112, 112, 112);/* Default text color */
}

/* Ensure the dropdown arrow color is set to the default */
.select-wrapper .caret {
    fill: #757575 !important; /* Default dropdown arrow color */
}

/* Reset the select dropdown arrow for the specific input */
.select-wrapper select {
    color: #000 !important; /* Ensure the text color is default */
}

.select-wrapper select option {
    color: #000 !important; /* Ensure the options text color is default */
}
...
/* 
		     ...
		     */
			    	 $("#overlay").show();
			        document.location.href = '${pageContext.request.contextPath}/payoutDataUser/exportPendingAndFailureGPVTxnAsEmail?date=' + fromDateString + '&date1=' + toDateString + '&emailId=' + email + '&export=' + exportType + '&username=' + businessName;
	...
	margin-left: 14px ! important;
		...
		<div id="successMailId" class="confirmation_email_class">
			<div class="confirmation_email_content_class">
				<div>
					<div
						style="padding: 15px 24px; text-align: center; font-size: 16px; color: #005baa; font-weight: 500; border-bottom: 1.5px solid #ffc800;">
						Notification</div>
        ...
        if (message && message.trim().length > 0 && message !== "null") {
            ...
            if (isEmailTriggered === "true") {
                ...
                if (modal) {
                    ...
                    if (ptag) {
                        ptag.innerHTML = "File has been sent to your email address. Please check your inbox.";
                    }
    ...
    <script>
		...
		<script type="text/javascript">
            ...
            <style>
             ...
             .select2-container {
    max-width: 250px !important; /* Set width limit */
    width: 100% !important;
}
...
.businessname {
    max-width: 250px !important; /* Restrict the container width */
    width: 100%;
    display: flex;
    flex-direction: column; /* Ensures label stays above select */
     margin-top: -10px; !important;/* Adjust this value as needed to align with others */
}

#label_businessname {
    margin-bottom: 14px !important; /* Adjust spacing between label and dropdown */
}
