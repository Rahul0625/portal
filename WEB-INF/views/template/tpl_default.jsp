		...
		<header class="topbar">
			...
			<nav>
				<div class="nav-wrapper">
					...
					<img
						src="${pageContext.request.contextPath}/resourcesNew1/assets/MobiBlueLogo.svg"
...
.has-arrow {
	margin-right: 0px !important;
		...
		<aside class="left-sidebar">
                ...
                <div class="collapsible-body">
                    <ul>
						...
						<li><a href="javascript: void(0);"
							...
							<div class="collapsible-body">
								...
								<%-- 	<c:if test="${userName.toLowerCase() == 'kavin' || 
									  userName.toLowerCase() == 'dhinesh' || 
									  userName.toLowerCase() == 'sangeetha' || 
									  userName.toLowerCase() == 'nandakumar'}">	 --%>	
									<li><a
						...
						<c:if test="${userName.toLowerCase() == 'kavin' || 
									  ...
									  userName.toLowerCase() == 'sharon shilpa antony cruz' || 
									  userName.toLowerCase() == 'vishweswar j' ||
            ...
            <li><a href="javascript: void(0);"
							class="collapsible-header has-arrow"><i
								class="material-icons">view_list</i><span class="hide-menu">PAYOUT
									Host Switch</span></a>
							<div class="collapsible-body">
								<ul>
								
									<li><a
										href="${pageContext.request.contextPath}/transaction/getPayoutHostSwitchUIForAll"
										onclick="loader()"><i class="material-icons">view_list</i><span
											class="hide-menu">All Merchants</span></a></li>
									<li><a
										href="${pageContext.request.contextPath}/transaction/getPayoutHostSwitchUIForCustomMerchants"
										onclick="loader()"><i class="material-icons">view_list</i><span
											class="hide-menu">Custom Merchants</span></a></li>
								</ul>
						  </div></li>
						...
						<c:if test="${userName.toLowerCase() == 'kavin' || 
									  ...
									  userName.toLowerCase() == 'rachel' || 
									  userName.toLowerCase() == 'jared chan' ||
									  userName.toLowerCase() == 'karupuadmin' ||
 ...
 --%>
						...
						<li><a
							href="${pageContext.request.contextPath}/Ezycash/getAdminsevenEleven"
							onclick="loader()" class="collapsible-header"><i
                ...
                <div class="collapsible-body">
                    ...
                    <c:if test="${userName.toLowerCase() == 'nishitha' || userName.toLowerCase() == 'ashiq' }">
                            <li><a style="display: flex;align-items:center;" href="${pageContext.request.contextPath}/currency-exchange/"
                                onclick="loader()" class="collapsible-header">
                                <img src="${pageContext.request.contextPath}/resourcesNew1/assets/Currency-Convert.svg" alt="XE" style="height: 24px;margin-right: 22px;"/>
                                <span class="hide-menu">Currency Exchange Rate</span></a>
                            </li>
                      </c:if>
