...
.has-arrow {
			...
			<ul id="slide-out" class="sidenav">
				...
				<li>
					<ul class="collapsible">
						...
						<c:if test="${userName.toLowerCase() == 'payout_boopathi' ||
							userName.toLowerCase() == 'payout_dhianeshwar' ||
							userName.toLowerCase() == 'payout_dineshdm' ||
							userName.toLowerCase() == 'payout_gajendhiran' ||
							userName.toLowerCase() == 'payout_dhivya' ||
							userName.toLowerCase() == 'payout_sathyaprabhu' ||
							userName.toLowerCase() == 'payout_vinoth'  ||
							userName.toLowerCase() == 'payout_pravin'}">

						<li><a
								href="${pageContext.request.contextPath}/payoutDataUser/list-pendingPayoutTransactions"
								class="collapsible-header " onclick="loader()"><i
								class="pending_payout"></i><span
								class="hide-menu">Pending Payout Transactions</span></a></li>
						</c:if>
 ...
 --%>
						...
						<li><a href="javascript: void(0);"
							...
							<li><a href="${pageContext.request.contextPath}/payoutDataUser/failureandPendingGPVReport"     
							  class="collapsible-header " onclick="loader()">
							  <i class="Failure_Transactions"></i> <span class="hide-menu">GPV Failure & Pending Report</span>
							  </a></li>
