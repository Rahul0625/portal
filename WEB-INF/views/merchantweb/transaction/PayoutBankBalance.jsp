					...
					<div class="card-body">
						<div class="row pad-1">
							...
							<div class="col-3 pad-0">
								<img class="img-fluid"
									src="${pageContext.request.contextPath}/resourcesNew1/assets/Ampbank.svg">
							</div>
							<!-- Content Container -->
							<div class="col-9 pad-0">
								<strong class="text-right "
									style="color: #72777B; font-size: 18px; font-weight: 600; white-space: nowrap;">AmBank
									Malaysia BerhadM2U</strong>
									
									<div>
										<strong class="text-right "
										style="color: #72777B; font-size: 16px; font-weight: 400; white-space: nowrap;">Account No : <span> ${settlementbankbalance.amBankAccNumber}</span></strong>
									</div>
								<div class="table-responsive"
									style="margin-top: 12px !important; color: #72777B; font-size: 16px;">
									<tr>
						...
						<div class="row pad-1" style="padding-top: 24px !important;">
							<table class="table table-borderless pad-0"
								Style="margin-bottom: 0rem;">
								<tbody>
									<tr>
										<td class=" pad-0"
											style="color: #1c1c1c; font-size: 20px; padding: 0px !important; font-weight: 600;"><span
											style="color: #72777B !important; font-weight: 600; font-size: 16px;">Balance
												: </span> RM ${settlementbankbalance.amBankBalance}</td>
									</tr>
								</tbody>
							</table>
						</div>
				...
				<div class="card card-mobi" style="border-radius: 0.9rem;">
					<div class="card-body">
						<div class="row pad-1">
							...
							<div class="col-3 pad-0">
								<img class="img-fluid"
									src="${pageContext.request.contextPath}/resourcesNew1/assets/OCDC1.svg">
							</div>
							<!-- Content Container -->
							<div class="col-9 pad-0">
								<strong class="text-right "
									style="color: #72777B; font-size: 18px; font-weight: 600;">OCBC
									Bank</strong>
									
									<div>
										<strong class="text-right "
										style="color: #72777B; font-size: 16px; font-weight: 400; white-space: nowrap;">Account No : <span> ${settlementbankbalance.ocbcBankAccNumber}</span></strong>
									</div>
								...
								<tbody>
									<tr>
										<td class=" pad-0"
											style="color: #1c1c1c; font-size: 20px; padding: 0px !important; font-weight: 600;"><span
											style="color: #72777B !important; font-weight: 600; font-size: 16px;">Balance
												: </span> RM ${settlementbankbalance.ocbcBankBalance}</td>
									</tr>
								</tbody>
							</table>
						</div>
				...
				<div class="card card-mobi" style="border-radius: 0.9rem;">
					<div class="card-body">
						<div class="row pad-1">
							...
							<div class="col-3 pad-0">
								<img class="img-fluid"
									src="${pageContext.request.contextPath}/resourcesNew1/assets/Maybank_Logomark.svg">
							</div>
							<!-- Content Container -->
							<div class="col-9 pad-0">
								<strong class="text-right "
									style="color: #72777B; font-size: 18px; font-weight: 600;">Maybank</strong>
									
									<div>
										<strong class="text-right "
										style="color: #72777B; font-size: 16px; font-weight: 400; white-space: nowrap;">Account No : <span> ${settlementbankbalance.mayBankAccNumber}</span></strong>
									</div>
								<div class="table-responsive"
									style="margin-top: 12px !important; color: #72777B; font-size: 16px;">
									<tr>
										<a>As of : ${settlementbankbalance.mayBankUpdatedDate}</a>
									</tr>
									<br>
								...
								<tbody>
									<tr>
										<td class=" pad-0"
											style="color: #1c1c1c; font-size: 20px; padding: 0px !important; font-weight: 600;"><span
											style="color: #72777B !important; font-weight: 600; font-size: 16px;">Balance
												: </span> RM ${settlementbankbalance.mayBankBalance}</td>
									</tr>
								</tbody>
							</table>
						</div>
				...
				<div class="card card-mobi" style="border-radius: 0.9rem;">
					<div class="card-body">
						<div class="row pad-1">
							...
							<div class="col-3 pad-0">
								<img class="img-fluid"
									src="${pageContext.request.contextPath}/resourcesNew1/assets/total.svg">
							</div>
							<!-- Content Container -->
							<div class="col-9 pad-0">
								<strong class="text-right "
									style="color: #72777B; font-size: 18px; font-weight: 600;">Total</strong>
								<div class="table-responsive"
									style="margin-top: 12px !important; color: #72777B; font-size: 16px;">
									<tr>
										<a>As of :
											${settlementbankbalance.totalBankBalanceUpdatedDate}</a>
									</tr>
									<br>
								...
								<tbody>
									<tr>
										<td class=" pad-0"
											style="color: #1c1c1c; font-size: 20px; padding: 0px !important; font-weight: 600;"><span
											style="color: #72777B !important; font-weight: 600; font-size: 16px;">Balance
												: </span> RM ${settlementbankbalance.totalBankBalance}</td>
									</tr>
								</tbody>
							</table>
						</div>
